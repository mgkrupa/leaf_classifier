...
@author: Matthew Gregory Krupa and Pearce Washabaugh
'''
...
print("The leaf indexed by %d, pictured below, is of the species %s." % (myId, myIdSpecies))
plt.imshow(pics[myId])
plt.show()

print('Below are all the TEST leaves of the species ' + myIdSpecies + ':')
